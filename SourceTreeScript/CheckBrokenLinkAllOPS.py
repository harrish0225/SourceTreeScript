...
tech_content_path = "E:/GitHub/mc-docs-pr.zh-cn/"
...
def sub_proc(input, output):
    ...
    while line!= TERMINATED:
        scan_one(line, output_mssg, tech_content_path, False)
        out = ""
...
def control_proc(inputs, outputs, worker_num):
    ...
    mdlist = list(glob.glob(tech_content_path + "**/*.md", recursive=True))
    ...
    subprocess.call(["PowerShell", "-ExecutionPolicy", "ByPass", "-File", "./sendFileOPS.ps1"], shell=True)
